...
const SOCKET_PATH = process.env.LOGDNA_DOCKER_SOCKET || '/var/run/docker.sock';
...
var processAllContainers = function(containers) {
    ...
    log('Found ' + Object.keys(networkIdToLabels).length + ' pods, ' + numLabels + ' labels in ' + SOCKET_PATH);
};
