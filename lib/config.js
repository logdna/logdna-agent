...
module.exports = {
    ...
    , DEFAULT_REQ_HEADERS: { 'Content-Type': 'application/json; charset=UTF-8', 'user-agent': process.env.LDUSERAGENT || process.env.USER_AGENT }
    , DEFAULT_REQ_HEADERS_GZIP: { 'Content-Type': 'application/json; charset=UTF-8', 'Content-Encoding': 'gzip', 'user-agent': process.env.LDUSERAGENT || process.env.USER_AGENT }
